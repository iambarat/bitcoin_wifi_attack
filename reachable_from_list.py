#!/usr/bin/env python3
"""reachable_from_list.py

Filter a CSV list of IPv4 Bitcoin node addresses (ip:port) to those
reachable via a Bitcoin P2P handshake.

Examples:
  python reachable_from_list.py --input ipv4_nodes.csv --out reachable.csv
  python reachable_from_list.py -i ipv4_nodes.csv -o -  # stdout
"""
